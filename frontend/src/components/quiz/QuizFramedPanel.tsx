...
interface QuizFramedPanelProps extends HTMLAttributes<HTMLElement> {
  /** Element (or component) used for the outer wrapper; defaults to a plain div. */
  tag?: ElementType;
  className?: string;
  children?: ReactNode;
}
 ...
 */
export default function QuizFramedPanel({ tag: Tag = 'div', className = '', children, ...rest }: QuizFramedPanelProps) {
